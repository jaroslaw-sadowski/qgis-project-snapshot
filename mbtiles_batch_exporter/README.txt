...
integrity and crash recovery). See the [user guide](INSTRUKCJA.md) and
[release test results](https://github.com/jaroslaw-sadowski/qgis-project-snapshot/blob/main/docs/release-1.0.2.md).
...
Więcej znajdziesz w [instrukcji](INSTRUKCJA.md)
i [wynikach testów wydania](https://github.com/jaroslaw-sadowski/qgis-project-snapshot/blob/main/docs/release-1.0.2.md).
