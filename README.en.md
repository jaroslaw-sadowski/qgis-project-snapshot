...
or English based on the QGIS language. Current version for testing: **0.9.1**.
...
The repository contains source code. To build the **0.9.1** ZIP, run:

```bash
python3 scripts/build_plugin.py
```

This creates `qgis-project-snapshot-0.9.1.zip` and its SHA-256 checksum in `dist/`,
